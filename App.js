...
//   console.log('AstraArt image path:', AstraArt);
//   console.log('cardData.img:', cardData.img);
...
//           "Meet Agnes. Agnes, like so many Healers, has been on quite a journey..."
//         </Text>
//         {!showHiddenText && (
...
//           <View>
//             <Text style={styles.hiddenText}>
//               "...Of mowing everything to the ground and starting anew - the phoenix from the ashes..."
//             </Text>
//             <TouchableOpacity onPress={toggleHiddenText}>
...
//     animationType="slide" // You can choose an animation type
//     transparent={true}
//   >
...
//     onPress={randomCardRequest}
//   >
//     <Text style={styles.randomButtonText}>Pick a Random Card</Text>
//   </TouchableOpacity>
// </View>
...
//             {cardData.meaning && <Text style={styles.meaningTitle}>Meaning:</Text>}
...
//           </View>
//         ) : (
//           // Display a default image if cardData.name is not available
//           <Image
//             source={AstraArt}
//             style={styles.astraImage}
//             resizeMode="cover"
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.resetButtonContainer}>
        <TouchableOpacity style={styles.resetButton} onPress={resetToAstraArt}>
          <Text style={styles.resetButtonText}>Reset to Astra Art</Text>
        </TouchableOpacity>
      </View>
